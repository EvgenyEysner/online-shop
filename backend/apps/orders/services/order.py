...
from apps.orders.models import Order, CheckoutDraft
...
class OrderService:
    """
    Orchestriert den Checkout-Flow: Draft anlegen, Stripe-Session erzeugen,
    Order-Erstellung bei erfolgreicher/pending Zahlung anstoßen.
    """
