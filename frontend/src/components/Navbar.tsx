...
import {LayoutDashboard, Menu, ShoppingCart, Sun, User, X, Zap,} from "lucide-react";
                ...
                <div className="flex items-center gap-2">
                  ...
                  Anmelden
                    ...
                    >
                        ...
                        {cartCount > 0 && (
                            <span
                                className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-accent text-primary text-xs font-black flex items-center justify-center">
